...
export default function ImageToPdf(): ReactElement {
  ...
  return (
    <div className=" h-screen bg-teal-800 flex justify-center items-center ">
      <div className=" border-dashed border-2 border-teal-200 rounded-md p-4">
        ...
        <div className=" mt-10 flex justify-center items-center">
          <button className="w-36 h-8 bg-green-500 rounded-md shadow-md" onClick={handleUpload}>Upload</button>
        </div>
      </div>
    </div>
  );
